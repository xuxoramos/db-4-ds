...
| `repeat(`_string o caracter a repetir_`,`_num de veces a repetir_`)` | text | Repetir _string_ por _num de veces_ | `select 'Were up all night for good fun! ' || repeat('Were up all night to get lucky! ', 5)` | **Were up all night for good fun! Were up all night to get lucky! Were up all night to get lucky! Were up all night to get lucky! Were up all night to get lucky! Were up all night to get lucky!** |
